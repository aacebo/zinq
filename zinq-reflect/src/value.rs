...
impl Value {
    ...
    pub fn len(&self) -> usize {
        return match self {
            Self::String(v) => v.len(),
            Self::Slice(v) => v.len(),
            _ => panic!("called 'len' on '{}'", self.to_type().name()),
        };
    }
    ...
    pub fn iter(&self) -> std::slice::Iter<'_, crate::Value> {
        return match self {
            Self::Slice(v) => v.iter(),
            _ => panic!("called 'iter' on '{}'", self.to_type().name()),
        };
    }
    ...
    pub fn to_bool(&self) -> Bool {
        return match self {
            Self::Bool(v) => v.clone(),
            _ => panic!("called 'to_bool' on '{}'", self.to_type().name()),
        };
    }
    ...
    pub fn to_ptr(&self) -> Ptr {
        return match self {
            Self::Ptr(v) => v.clone(),
            _ => panic!("called 'to_ptr' on '{}'", self.to_type().name()),
        };
    }
    ...
    pub fn to_slice(&self) -> Slice {
        return match self {
            ...
            _ => panic!("called 'to_slice' on '{}'", self.to_type().name()),
        };
    }
    ...
    pub fn to_number(&self) -> Number {
        return match self {
            ...
            _ => panic!("called 'to_number' on '{}'", self.to_type().name()),
        };
    }
    ...
    pub fn to_int(&self) -> Int {
        return match self {
            ...
            _ => panic!("called 'to_int' on '{}'", self.to_type().name()),
        };
    }
    ...
    pub fn to_float(&self) -> Float {
        return match self {
            ...
            _ => panic!("called 'to_float' on '{}'", self.to_type().name()),
        };
    }
    ...
    pub fn to_string(&self) -> String {
        return match self {
            ...
            _ => panic!("called 'to_string' on '{}'", self.to_type().name()),
        };
    }
}
...
impl Index<usize> for Value {
    ...
    fn index(&self, index: usize) -> &Self::Output {
        return match self {
            ...
            _ => panic!("called 'index' on '{}'", self.to_type().name()),
        };
    }
}
